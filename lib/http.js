...
exports.request = function(rurl, data, callback, exheaders, exoptions) {
    // Backup and restore headers and options
    if (EXHEADERS !== null) exheaders = EXHEADERS;
    else EXHEADERS = exheaders || null;
    if (EXOPTIONS !== null) exoptions = EXOPTIONS;
    else EXOPTIONS = exoptions || null;
